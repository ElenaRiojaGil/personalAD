	...
	public static void main(String[] args) {
		...
		try {
			...
			ResultSet resultado = stm.executeQuery(
					"SELECT count(p.CodigoLibro) as 'Num Libro' from PRESTAMO p, SOCIO s where Codigo=(SELECT p.CodigoLibro from PRESTAMO p where p.FechaInicio< date() AND p.FechaFin> date()) ;");
