	...
	public static void main(String[] args) {
		...
		try {
			...
			//Armar el postulado SQL y enviarlo a ejecución usando  el Statement.
			 ...
			 ResultSet resultado = stm.executeQuery("SELECT DISTINCT titulo from LIBRO,PRESTAMO where LIBRO.Codigo=PRESTAMO.CodigoLibro AND date(PRESTAMO.FechaFin)> date();");
